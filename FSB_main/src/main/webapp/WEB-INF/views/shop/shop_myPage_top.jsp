...
<ul class="nav nav-pills nav-fill">  
  ...
  <li class="nav-item">
    <a class="nav-link" href="#"><img src="resources/img/shop_coupon.png" alt="쿠폰" width="70" height="70"><font size="2" color="#4169e1"><br>쿠폰</font></a>
  </li>
  <li class="nav-item">
    <a class="nav-link" href="#"><img src="resources/img/shop_point.png" alt="포인트" width="70" height="70"><font size="2" color="#4169e1"><br>포인트</font></a>
  </li>
</ul>
