			...
			<div class="col-8 py-2">
				...
				<table border="0" width="100%" height="80%" align="center">
					...
					<tr height="60">
						...
						<td width="80%"><input type="text" class="form-control" name="sr_title" placeholder="제목을 작성해주세요.(최대 50자)"></td>
					</tr>
					<tr height="60">
						<th width="20%">리뷰 내용</th>
						<td width="80%"><textarea name="sr_content" class="form-control" id="sr_content" rows="7" placeholder="내용을 50자 이상 입력해주세요."></textarea></td>
					</tr>
					<tr>
					...
					<tr>
						<td colspan="2" align="center">
							<button class="btn btn-outline-dark" type="button" onclick="javascript:submitform()">리뷰등록</button>
