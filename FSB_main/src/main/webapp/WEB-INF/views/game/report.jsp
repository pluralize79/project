...
<body>
<form name="f3" action="review_report.do" method="post">
...
<div align="center">
	...
	<hr>
	<div class="form-check">
  		<input class="form-check-input" type="radio" name="review_report" value="2" id="flexRadioDefault2">
	...
	<hr>
	<div class="form-check">
  		<input class="form-check-input" type="radio" name="review_report" value="3" id="flexRadioDefault3">
	...
	<hr>
	<div class="form-check">
 		<input class="form-check-input" type="radio" name="review_report" value="4" id="flexRadioDefault4">
	...
	<hr>
	<div class="form-check">
  		<input class="form-check-input" type="radio" name="review_report" value="5" id="flexRadioDefault5">
