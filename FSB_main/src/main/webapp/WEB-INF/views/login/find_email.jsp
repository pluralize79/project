...
<div class="accordion-item">
  ...
  <input type="text" class="form-control" id="name" name="name" value="${name}">
     ...
     <div class="input-group mb-3">
 	<label for="exampleFormControlTextarea1" class="form-label"></label>
 	<input type="text" class="form-control" id="email" name="email" title="이메일"  value="${email}" aria-label="Recipient's username" aria-describedby="button-addon2" >
     </div>
     
     <div class="input-group mb-3">     
            <input  class="form-control" id="email_injeung" type="text" name="email_injeung" title="인증번호 입력" placeholder="인증번호 입력해주세요" aria-label="Recipient's username2" aria-describedby="button-addon2"> 
           <button type="submit" class="btn btn-light"  value="인증확인" id="check">인증 확인</button> 
           </div>
